...
const comprarcatalogo = document.getElementById('comprar')
const comprarventas = document.getElementById('comprar')
...
function saludo(){
     var msg="llegara muy pronto el pedido"
     alert(msg);
}
function comprar(){
     e.comprarventasdefault();
     e.comprarcatalogodefault();
     location.href="formilario.html";
